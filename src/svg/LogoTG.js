  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 370.5 399.13" {...props}>
    ...
    <g id="Layer_2" data-name="Layer 2">
      <g id="Layer_1-2" data-name="Layer 1">
        <g id="In">
          <path className="cls-1" d="m5 217.76 183.26 176.37" />
          <path className="cls-2" d="M188.26 394.13 365.5 220.15" />
          <path
            style={{
              stroke: "#b4b4b4",
              fill: "none",
          ...
          />
          <path className="cls-4" d="M188.26 394.13 365.5 220.15" />
          <path
            style={{
              fill: "#b4b4b4",
            }}
          ...
          <path
            ...
            d="M188.25 42.9 365.5 220.15"
          />
          <path className="cls-4" d="M188.25 42.9 365.5 220.15" />
          <path
            style={{
              fill: "none",
              strokeMiterlimit: 7,
            ...
            d="M188.25 42.9 365.5 220.15"
          />
          <path className="cls-2" d="M188.25 42.9 365.5 220.15" />
          <path className="cls-1" d="M54.22 173.02 188.25 42.9" />
        </g>
        <g id="Out">
          <path
            className="cls-1"
